from shared_constants import ML_RESEARCH_CATEGORIES, BaseState, PropertyHit, Evidence
...
def format_search_string(query):
    ...
    # Replace forward slashes with AND operators and handle special characters
